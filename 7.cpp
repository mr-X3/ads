/*Assignment no:-7
Title:-Implement all the function of dictionary(ADT) using hashing data set of (key value)pair key are mapped: to value key must be comparable key must be unique standard operation insert (key value),find (key),delete (key).
Class:-SE-A
Batch:-SA-4
Roll no.:-64*/
#include<iostream>
